...
var testTime, _ = time.Parse(`"2006-01-02T15:04:05Z"`, `"2014-09-29T14:44:31Z"`)
var timeTestValue = timeTest{CreatedAt: &Iso8601DateTime{testTime}}
...
type timeTest struct {
	CreatedAt *Iso8601DateTime `json:"created_at"`
}
