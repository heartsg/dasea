...
type EnvironmentLoader struct {
	...
	// The name used in tag to represent env, default value is "env"
	// for example, a tag `env:"ACCESSKEY"` will search for ACCESSKEY env variables,
	// regardless prefix/camel etc. settings.
	EnvTagName string
}
